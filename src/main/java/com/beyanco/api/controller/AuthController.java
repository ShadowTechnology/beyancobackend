...
import com.beyanco.api.payload.request.LoginRequest;
import com.beyanco.api.payload.request.SignupRequest;
import com.beyanco.api.payload.response.JwtResponse;
...
import com.beyanco.api.security.jwt.JwtUtils;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest) {
        ...
        return ResponseEntity.ok(new JwtResponse(jwt,
                ...
                userDetails.getSubscriptionType(),
                userDetails.getCreditsRemaining()));
    }
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignupRequest signUpRequest) {
        ...
        user.setCreditsRemaining(3); // Give 3 free credits to start
